...
typedef enum {
    ...
    NMSP_OBJECT_TYPE_SES_EVT_ATT = 0x09,    /*!< Used to create a vector of nmsp_calllog_SessionEvent_AttributeEntry */
    NMSP_OBJECT_TYPE_SES_EVT     = 0x0A,	/*!< Used to create a vector of nmsp_calllog_resource_SessionEventData */
	NMSP_OBJECT_TYPE_SSL_PARAM   = 0x0B		/*!< Used to create a vector of nmsp_Parameter for calllog */
